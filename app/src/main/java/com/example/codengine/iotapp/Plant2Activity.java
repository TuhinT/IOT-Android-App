...
public class Plant2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.plant2_activity);
        ...
        water.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i2 = new Intent(Plant2Activity.this,Wateractivity.class);
        ...
        light.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i3 = new Intent(Plant2Activity.this,Wateractivity.class);
    ...
    class Plant2task extends AsyncTask<Void, Void, boolean[]> {
            ...
            try {
                ...
                if (inputStream != null)
                {
                    ...
                    try {
                        ...
                        JSONArray p1 = partition.getJSONArray("0013A200410809E3");
