...
public class Plant3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.plant3_activity);
        ...
        water.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i2 = new Intent(Plant3Activity.this,Wateractivity.class);
        ...
        light.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i3 = new Intent(Plant3Activity.this,Wateractivity.class);
    ...
    class Plant3task extends AsyncTask<Void, Void, boolean[]> {
        private final String LOG_TAG = getClass().getSimpleName();

        String jsonresponse, humidval, tempval,timestampval, append;
            ...
            try {
                ...
                if (inputStream != null)
                {
                    ...
                    try {
                        ...
                        JSONArray p1 = partition.getJSONArray("0013A200410809D8");
                        for(int i =0; i< p1.length(); i++)
                        {
                            ...
                            append += timestampval +"\t" + humidval + "\t" + tempval+"\n";
                    ...
                    b1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            tv1.setText("Timestamp"+"\t"+"Humidity"+ "\t" + "Temperature"+"\t"+"Light Intensity"+"\t"+"Soil Moisture"+"\n"+append);
                        }
                    });
